...
```
cd existing_repo
git remote add origin https://gitlab.com/saidulislam2822/t_and_s_institute_managment.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/saidulislam2822/t_and_s_institute_managment/-/settings/integrations)
